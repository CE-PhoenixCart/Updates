# Instructions for Manually Updating CE Phoenix 1.0.8.12 to 1.0.8.13
## Before update
* Before deleting any files, back them up (and remember that best practice is to back up the entire site and database before updating).
* Make sure that any module with files that you are deleting is uninstalled.  

## REQUIRED Modules to Remove (aka uninstall):
* None

## OPTIONAL  Modules to Remove (aka uninstall):
* PayPal (All; includes payment modules and the login content module)
* Braintree
* WorldPay
* Sage Pay (Opayo)
* NoChex
...
## Upload https://github.com/CE-PhoenixCart/Updates/raw/master/1.0.8.13/1.0.8.12/update.zip
or
## Perform the following file changes in each commit:
* (https://github.com/CE-PhoenixCart/PhoenixCart/compare/1.0.8.12...1.0.8.13)
...
* admin/includes/boxes/paypal.php
* admin/includes/languages/english/modules/boxes/paypal.php
* admin/includes/languages/english/modules/dashboard/d_paypal_app.php
* admin/includes/modules/dashboard/d_paypal_app.php
* admin/paypal.php
...
* includes/apps/braintree_cc/Braintree/Plan.php
...
* includes/apps/paypal/admin/content/start.php
...
* includes/apps/paypal/languages/english/modules/HS/cfg_params/sort_order.php
...
* includes/apps/paypal/modules/HS/cfg_params/status.php
...
* templates/default/includes/ext/modules/payment/paypal/hosted_checkout.php
